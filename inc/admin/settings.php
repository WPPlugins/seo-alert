...
<!--
                            Other : <label for="vbean_seoalert_othersearch"><input type="radio" class="checkbox" name="vbean_seoalert_othersearch"  id="vbean_seoalert_othersearch" value="1" <?php echo checked(1, get_option('vbean_seoalert_othersearch'), false)   ?>/>All</label>
                            &nbsp;&nbsp;&nbsp; <label for="vbean_seoalert_othersearch"><input type="radio" class="checkbox" name="vbean_seoalert_othersearch"  id="vbean_seoalert_othersearch" value="2" <?php echo checked(2, get_option('vbean_seoalert_othersearch'), false)   ?>/>Max one daily</label>
                            &nbsp;&nbsp;&nbsp; <label for="vbean_seoalert_othersearch"><input type="radio" class="checkbox" name="vbean_seoalert_othersearch"  id="vbean_seoalert_othersearch" value="0" <?php echo checked(0, get_option('vbean_seoalert_othersearch'), false)   ?>/>Never</label><br />
-->
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <div class="vb-sub">Google : </div><label for="vbean_seoalert_googlebotslack"><input type="radio" class="checkbox" name="vbean_seoalert_googlebotslack"  id="vbean_seoalert_googlebotslack" value="1" <?php echo checked(1, get_option('vbean_seoalert_googlebotslack'), false)   ?>/>All</label>
                            &nbsp;&nbsp;&nbsp; <label for="vbean_seoalert_googlebotslack"><input type="radio" class="checkbox" name="vbean_seoalert_googlebotslack"  id="vbean_seoalert_googlebotslack" value="2" <?php echo checked(2, get_option('vbean_seoalert_googlebotslack'), false)   ?>/>Max one daily</label>
                            &nbsp;&nbsp;&nbsp; <label for="vbean_seoalert_googlebotslack"><input type="radio" class="checkbox" name="vbean_seoalert_googlebotslack"  id="vbean_seoalert_googlebotslack" value="0" <?php echo checked(0, get_option('vbean_seoalert_googlebotslack'), false)   ?>/>Never</label><br />

                            <div class="vb-sub">Yahoo : </div><label for="vbean_seoalert_yahoobotslack"><input type="radio" class="checkbox" name="vbean_seoalert_yahoobotslack"  id="vbean_seoalert_yahoobotslack" value="1" <?php echo checked(1, get_option('vbean_seoalert_yahoobotslack'), false)   ?>/>All</label>
                            &nbsp;&nbsp;&nbsp; <label for="vbean_seoalert_yahoobotslack"><input type="radio" class="checkbox" name="vbean_seoalert_yahoobotslack"  id="vbean_seoalert_yahoobotslack" value="2" <?php echo checked(2, get_option('vbean_seoalert_yahoobotslack'), false)   ?>/>Max one daily</label>
                            &nbsp;&nbsp;&nbsp; <label for="vbean_seoalert_yahoobotslack"><input type="radio" class="checkbox" name="vbean_seoalert_yahoobotslack"  id="vbean_seoalert_yahoobotslack" value="0" <?php echo checked(0, get_option('vbean_seoalert_yahoobotslack'), false)   ?>/>Never</label><br />

                            <div class="vb-sub">Bing : </div><label for="vbean_seoalert_bingbotslack"><input type="radio" class="checkbox" name="vbean_seoalert_bingbotslack"  id="vbean_seoalert_bingbotslack" value="1" <?php echo checked(1, get_option('vbean_seoalert_bingbotslack'), false)   ?>/>All</label>
                            &nbsp;&nbsp;&nbsp; <label for="vbean_seoalert_bingbotslack"><input type="radio" class="checkbox" name="vbean_seoalert_bingbotslack"  id="vbean_seoalert_bingbotslack" value="2" <?php echo checked(2, get_option('vbean_seoalert_bingbotslack'), false)   ?>/>Max one daily</label>
                            &nbsp;&nbsp;&nbsp; <label for="vbean_seoalert_bingbotslack"><input type="radio" class="checkbox" name="vbean_seoalert_bingbotslack"  id="vbean_seoalert_bingbotslack" value="0" <?php echo checked(0, get_option('vbean_seoalert_bingbotslack'), false)   ?>/>Never</label><br />

<!--
                            Other : <label for="vbean_seoalert_othersearchslack"><input type="radio" class="checkbox" name="vbean_seoalert_othersearchslack"  id="vbean_seoalert_othersearchslack" value="1" <?php echo checked(1, get_option('vbean_seoalert_othersearchslack'), false)   ?>/>All</label>
                            &nbsp;&nbsp;&nbsp; <label for="vbean_seoalert_othersearchslack"><input type="radio" class="checkbox" name="vbean_seoalert_othersearchslack"  id="vbean_seoalert_othersearchslack" value="2" <?php echo checked(2, get_option('vbean_seoalert_othersearchslack'), false)   ?>/>Max one daily</label>
                            &nbsp;&nbsp;&nbsp; <label for="vbean_seoalert_othersearchslack"><input type="radio" class="checkbox" name="vbean_seoalert_othersearchslack"  id="vbean_seoalert_othersearchslack" value="0" <?php echo checked(0, get_option('vbean_seoalert_othersearchslack'), false)   ?>/>Never</label><br />
-->
                            ...
                            if (empty($slackvalid)){
                            ?>
                            <div class="error">* Your Vanilla Bean Slack Message plugin is not installed or not configured correctly.</div>
                                <?php
